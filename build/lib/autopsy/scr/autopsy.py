...
class PropertyCalculator:
    ...
    def calculate_vhf(self, positions, indices, atom):
        ...
        self.df_displacement[f'{atom}_xyz_displacement'] = np.insert(displacement[0], 0, 0)
        self.df_displacement[f'{atom}_x_displacement'] = np.insert(displacement[1], 0, 0)
        self.df_displacement[f'{atom}_y_displacement'] = np.insert(displacement[2], 0, 0)
        self.df_displacement[f'{atom}_z_displacement'] = np.insert(displacement[3], 0, 0)
        print("VHF is DONE")
    ...
    def write_outputs(self):
        ...
        '''
        # Save to CSV
        self.df.to_csv('msd_and_ngp.csv', index=False)
